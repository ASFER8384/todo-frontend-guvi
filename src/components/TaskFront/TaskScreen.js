...
const [taskIdforEdit, setTaskIdforEdit] = useState("");
  ...
  return (
    <div className='relative bg-[#fff]  h-[95vh] w-[100vw] sm:w-[100vw] flex flex-col items-center'>
      ...
      <button onClick={handleAddTask} className='mt-12 flex gap-3 w-[80%] sm:w-[60%] border-[3px] border-[#1d1d25]-600 px-4 py-3 rounded-2xl group'>
