...
const TaskCard = ({task, setShowEditTaskModal, setTaskIdforEdit}) => {
  ...
  return (
    <div className='  bg-[#fff] px-4 py-3 rounded-2xl group cursor-pointer border-2 border-solid border-black-600'>
       ...
       <button onClick={handleCheck}>
         ...
         <div style={task.checked?{
          ...
          display:'none'
           ...
           <div className=''>
           <h4 className='text-[black] text-[1rem] overflow-hidden  '>
            {
